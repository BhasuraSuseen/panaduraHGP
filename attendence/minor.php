                ...
                <div class="attmiddle_right">
                    ...
                    <div class="attrecordstyl"> 
                        ...
                        <table border="0" style="width: 100%">
                            ...
                            <tr><td style="width:60%;"><button class="attblack_btn" onclick="loadMinordata(document.getElementById('day1').value)">Get Report</button></td></tr>
                    ...
                    <div class="attrecordstyl"> 
                        ...
                        <br>
                            <a href="/attendence/reportMinor.php">  <input class="attblack_btn" type="submit" value="Download Pdf"></a> 
