            ...
            <div class="attcontainer">
                ...
                <div class="attmiddle_right">
                    ...
                    <div class="attrecordstyl">
                        ...
                        <tr><td style="width:40%">Day</td><td><?php echo $yearmon;?><select class="attstyled-select" style="width:40%" id="day1">
                            ...
                            <tr><td style="width:60%;"><button class="attblack_btn" onclick="loadEbdata(document.getElementById('day1').value)">Summary</button></td></tr>
