...
require "connect.php";
session_start();
if(($_SESSION['admin']!='AB')or($_SESSION['ebno']!=8)){
    ...
    <div class="right_side_bar"> 
     ...
     <div id="pop_background"></div>
            ...
            <div id="pop_box_mail_2">
                <div style="width: 100%; background-color: #2980b9;"><a style="font-size: 16px; color: #fafafa; padding: 10px;">LETTER REPLY FORM </a></div>
                          <div style="width:100%;background: #fff; padding: 10px;  box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19);"> 
                              ...
                              <form name="replyletter" action="attendancemaileb4.php" method="post" accept-charset="utf-8" enctype="multipart/form-data">
            ...
            <div id="pop_box_att_2">
                  ...
                  <div style="width:100%;background: #fff; padding: 10px;  box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19);"> 
                                    <?php  include 'leave/minorLeave.php' ?>
                  </div>
            </div>
            <div id="pop_box_report_1">
                  ...
                  <div style="width:100%;background: #fff; padding: 10px;  box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19); overflow-y: scroll"> 
            ...
            <div id="pop_box_att_1">
                  ...
                  <div style="width:100%;background: #fff; padding: 10px;  box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19); overflow-y: scroll"> 
                                    <?php  include 'attendence/minor.php'; ?>  
                  </div>
            </div>
